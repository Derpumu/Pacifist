...
local _modify_capture_capsule = function()
    ...
    capture_bot_capsule.subgroup = "pacifist-sa-capture"
    capture_bot_capsule.capsule_action.attack_parameters.ammo_category = "pacifist-sa-capture-robot"
